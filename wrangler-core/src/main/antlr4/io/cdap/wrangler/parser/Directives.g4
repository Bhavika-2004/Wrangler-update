...
value
 ...
 | TIME_DURATION
 ;
  byteSizeArg : BYTE_SIZE;   //  Explicit rule for BYTE_SIZE
  timeDurationArg : TIME_DURATION;  //  Explicit rule for TIME_DURATION
...
fragment TIME_UNIT : 'ms' | 'sec' | 's' | 'min' | 'hour' | 'day' ;
